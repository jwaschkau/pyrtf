...
def MakeExample2():
    ...
    p.append(
        'In this case we have used a two styles. '
    ...
    p = Paragraph()
    p.append(
        'Notice that after I have changed the style of the paragraph '
    ...
    p = Paragraph()
    p.append(
        'I also happen to like Arial so our base style is Arial not Times New Roman.'
    )
    section.append(p)
    ...
    p.append(
        ...
        TEXT('size', size=48), ' or ',
        TEXT('typeface', font=ss.Fonts.Impact), '.')
    section.append(p)

    p = Paragraph()
    p.append(
        'The paragraph itself can also be overridden in lots of ways, tabs, '
    ...
    section.append(
        'The alignment of tabs and style can also be controlled. '
    ...
    section.append(
        'Paragraphs can also be indented, the following is all at the '
    ...
    section.append(
        'The following text was copied from http://www.shakespeare-online.com/plots/1kh4ps.html.'
    )
...
def MakeExample4():
    ...
    p.append('This next word should be in ',
             TEXT('Green', colour=ss.Colours.Green))
    section.append(p)
