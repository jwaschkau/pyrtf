...
class TextPropertySet :
    def __init__(self, font=None, size=None, bold=None, italic=None, underline=None, colour=None, frame=None,
                 expansion=None):
        self.SetFont(font)
        self.SetSize(size)
...
class ParagraphPropertySet :
    ...
    def __init__(self, alignment=None, space_before=None, space_after=None, tabs=None, first_line_indent=None,
                 left_indent=None, right_indent=None, page_break_before=None):
        self.SetAlignment(alignment or self.LEFT)
